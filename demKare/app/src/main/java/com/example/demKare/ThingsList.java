...
import com.example.demKare.EditThingsItem;
 ...
 */
public class ThingsList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //hardcode 2 items
        addLikedItem("Spiti mou","","To spiti mou me odo Spiridonos 2",null,"@drawable/myhouse");
        addLikedItem("To aftokinito mou","","Afto ine to aftokinito mou an to ksexaso me noume AAA001",null, "@drawable/car");
    }
    ...
    private void createDescriptionPopup(String text) {
        AlertDialog.Builder builder = new AlertDialog.Builder(ThingsList.this);
