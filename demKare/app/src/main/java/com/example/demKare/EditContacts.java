...
public class EditContacts extends AppCompatActivity {
    ...
    private TextView nameText, surnameText, relationshipText, phoneNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Choose viewables
        personImgView = (ImageView) findViewById(R.id.PersonImageEdit);
        nameText = (TextView) findViewById(R.id.PersonEditName);
        surnameText = (TextView) findViewById(R.id.PersonEditSurname);
        relationshipText = (TextView) findViewById(R.id.PersonEditRelationship);
        phoneNumber = (TextView) findViewById(R.id.PersonEditPhone);
        saveButton = (Button) findViewById(R.id.PersonSaveButton);
        setPicButton = (Button) findViewById(R.id.PersonSetPicButton);
    ...
    private void savePerson() {
        ...
        boolean errorNumber = phoneNumber.getText() == null || phoneNumber.getText().length() == 0;

        if (errorName || errorSurname || errorRelationship || errorNumber) {
            Toast.makeText(EditContacts.this, "Please fill all mandatory fields", Toast.LENGTH_SHORT).show();
        }
        // Can only save if there are no errors
            ...
            bundle.putSerializable("number", phoneNumber.getText().toString());
